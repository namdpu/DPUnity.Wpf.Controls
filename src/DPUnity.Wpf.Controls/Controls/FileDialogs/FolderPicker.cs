...
namespace DPUnity.Wpf.Controls.Controls.FileDialogs
{
    public class FolderPicker
    {
        ...
        public bool? ShowDialog(Window owner = null, bool throwOnError = false)
        {
            ...
            return ShowDialog(owner != null ? new WindowInteropHelper(owner).Handle : 0, throwOnError);
        }

        // for all .NET
        public virtual bool? ShowDialog(nint owner, bool throwOnError = false)
        {
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        {
            [PreserveSig] int Show(nint parent); // IModalWindow
